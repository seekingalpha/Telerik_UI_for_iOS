 ...
 */
- (void)monthPresenter:(TKCalendarMonthPresenter*)presenter inlineEventsViewDidShowForCell:(TKCalendarDayCell*)cell;
 ...
 */
- (void)monthPresenter:(TKCalendarMonthPresenter*)presenter inlineEventsViewDidHideForCell:(TKCalendarDayCell*)cell;
 ...
 */
- (TKCalendarDayCell*)cellForDate:(NSDate*)date;
 ...
 */
- (void)showInlineEventsForCell:(TKCalendarDayCell*)cell animated:(BOOL)animated;
 ...
 */
- (TKCalendarCell*)createCellWithType:(TKCalendarCellType)cellType;
